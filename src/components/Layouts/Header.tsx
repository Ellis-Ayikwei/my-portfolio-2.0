    ...
    return (
        <header className="z-40">
            <div className="shadow-sm">
                <div className="bg-white dark:bg-black flex w-full items-center px-5 py-2.5">
                    ...
                    <div className="flex gap-3 mr-auto ml-auto">
                        <div className="flex items-center p-2 px-4 rounded-full bg-black dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60 text-white"> About</div>
                        <div className="flex items-center p-2 px-4 rounded-full bg-black dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60 text-white"> Projects</div>
                        <div className="flex items-center p-2 px-4 rounded-full bg-black dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60 text-white"> Blog</div>
                        <div className="flex items-center p-2 px-4 rounded-full bg-black dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60 text-white"> Experience</div>
                    </div>
